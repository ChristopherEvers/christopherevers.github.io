...
function clickChecker() {
    for (image of images) {
        image.addEventListener('click', function() {
            item = this.id.substring(8).slice(0, -9);
            switch (item) {
                case 'espresso':
                    totalCost = parseFloat(totalCost) + 1.95;
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$1.95 - Espresso')
                    );
                ...
                case 'latte':
                    ...
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$2.95 - Latte')
                    );
                ...
                case 'cappuccino':
                    ...
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$3.45 - Cappuccino')
                    );
                ...
                case 'coffee':
                    ...
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$1.75 - Coffee')
                    );
                ...
                case 'scone':
                    ...
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$1.95 - Scone')
                    );
                ...
                case 'biscotti':
                    ...
                    itemsAdded = document.createElement('option');
                    itemsAdded.appendChild(
                        document.createTextNode('$2.95 - Biscotti')
                    );
